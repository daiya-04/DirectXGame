...
const float OutLine::kClearColor_[4] = { 0.1f,0.25f,0.5f,1.0f };
...
void OutLine::CreateGraphicsPipelineState() {
	...
	ComPtr<IDxcBlob> pixelShaderBlob = DXCompiler::GetInstance()->ShaderCompile(L"OutLine.PS.hlsl", L"ps_6_0");
